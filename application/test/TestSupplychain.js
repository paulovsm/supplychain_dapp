...
contract('SupplyChain', function(accounts) {
    ...
    ///Available Accounts
    ///==================
    // (0) 0xbc865d04ecd86bdc75da2aef0b281f8a3a74b53c
    // (1) 0x9adc5429d71d5279cd84263526e31b2df793b11a
    // (2) 0xa13506f254b31ef7b253c1e5a7235846d82da069
    // (3) 0xb797ac6e30dc09605e0a83f58bc29b6970c9d96d
    // (4) 0xa3f32577fff9b70a6aabf4b2bff799239d4bbfbb
    // (5) 0x9afd048d86a2b3ff1a0d504af1d216def6a1c775
    // (6) 0x67c0015d0b6f94ad5ee9213e10a666038ed36a5d
    // (7) 0x7b9e6066ce3ce89323d41ea6b066ff00b5dd3214
    // (8) 0x71a1bcbea1d52f9b4ab6707990ea87058f7a4ea2
    // (9) 0xf8b872d2c85eae6e6b314c7a4c1d41427c72fe6c
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        let result = await supplyChain.harvestItem(upc, originFarmerID, originFarmName, 
            originFarmInformation, originFarmLatitude, originFarmLongitude, productNotes, 
            {from: originFarmerID})
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[5], itemState, 'Error: Invalid item State. Expected: 1-Processed')
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[5], itemState, 'Error: Invalid item State. Expected: 2-Packed')
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        assert.equal(resultBufferTwo[5], itemState, 'Error: Invalid item State. Expected: 3-ForSale')
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        assert.equal(resultBufferTwo[5], itemState, 'Error: Invalid item State. Expected: 4-Sold')
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[5], itemState, 'Error: Invalid item State. Expected: 5-Shipped')
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        assert.equal(resultBufferTwo[5], itemState, 'Error: Invalid item State. Expected: 6-Received')
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        assert.equal(resultBufferTwo[5], itemState, 'Error: Invalid item State. Expected: 7-Purchased')
